...
export class AddPatientModal extends Component {
    ...
    handleSubmit(event) {
        ...
        fetch('http://localhost:36468/api/patient', {
            ...
            body: JSON.stringify({
                //TeamId:null,
                Username: event.target.Username.value, FullName: event.target.FullName.value, Email: event.target.Email.value, Password: event.target.Password.value, NrTel: event.target.NrTel.value, Role: event.target.Role.value
