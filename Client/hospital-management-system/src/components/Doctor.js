...
//     //   this.props.history.push('/login'); // Redirect to login if not logged in
//     // }
//   }
//   // componentDidUpdate() {
//   //     this.refreshList();
...
export class Doctor extends Component {
  ...
  filterDoctorr = () => {
    const { doctorr, searchQuery } = this.state;
    return doctorr.filter((doctor) =>
  ...
  render() {
    ...
    const filteredDoctorr = this.filterDoctorr();
      ...
      <div>
        ...
        <div className="container">
          ...
          <ButtonToolbar>
            ...
            <AddDoctorModal show={addModalShow} onHide={addModalClose} />
